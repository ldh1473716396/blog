...
<div style="text-align:center; margin-top: 55px; margin-bottom: 50px;"><h1>{$cate['cate_name']}</h1></div>
<div class="container">
<div class="row">
...
<div class="col-md-6 col-lg-3">
	...
	<a href="{:url('user/article/read',array('id'=>$data.id))}" target="_blank">
		...
		{/if}
		<figcaption class="figure-caption"><h5>{$cate.cate_name}</h5></figcaption>
